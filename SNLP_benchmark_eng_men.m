function [r,rho,coverage]=SNLP_benchmark_eng_men(corpus,smoothing)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%Test word-embeddings from a english-based corpus with behavioral feature-norming data from Bruni & Baroni, 2013.
%%%% 	Bruni, E., Tran, N. K., & Baroni, M. (2014).
%%%% 	Multimodal distributional semantics.
%%%% 	Journal of artificial intelligence research, 49, 1-47.
%%%%	doi: 110.1613/jair.4135
%%%%
%%%%Usage:
