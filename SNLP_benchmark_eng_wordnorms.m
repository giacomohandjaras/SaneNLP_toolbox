function [r,rho,acc,RDM_behav,RDM_corpora,concepts_labels,coverage]=SNLP_benchmark_eng_wordnorms(corpora,smoothing)
...
[vectors_mask] = SNLP_searchWords(words_eng, corpora.wordlist);
...
if(smooth>0)
wordvectors_extracted = SNLP_getWordVectorsSmoothed(words_eng, corpora.wordlist, corpora.vectors_matrix, words_eng_stem, corpora.wordlist_stem, smooth);
else
wordvectors_extracted = SNLP_getWordVectors(words_eng, corpora.wordlist, corpora.vectors_matrix);
end
