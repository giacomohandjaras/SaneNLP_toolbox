function [root_position, word_position, exception]=SNLP_get_longest_exception(root,word,exceptions)
debug=0;
...
if(debug==1); disp(sprintf('Suffisso più lungo: %s',exceptions{exceptions_indx}));end
