function [r,rho,coverage]=SNLP_benchmark_eng_rg65(corpus,smoothing)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%Test word-embeddings from a english-based corpus with behavioral feature-norming data from Rubenstein & Goodenough (RG-65) dataset.
%%%%	Rubenstein, H., & Goodenough, J. B. (1965).
...
load 'SNLP_benchmark_eng_rg65.mat';
