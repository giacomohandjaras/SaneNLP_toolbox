function [r,rho,acc,RDM_behav,RDM_corpus,concepts_labels,coverage]=SNLP_benchmark_ita_wordnorms(corpus,smoothing)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%Test word-embeddings from an italian-based corpus with behavioral feature-norming data from Buchanan et al. semantic word-pair norms (2013).
%%%%Words from Buchanan et al. (2013) were translated by giacomo handjaras.
...
%%%%
%%%%Usage:
%%%%	[r,rho,acc,RDM_behav,RDM_corpus,concepts_labels,coverage]=SNLP_benchmark_ita_wordnorms(corpus,smoothing)
%%%%
...
[vectors_mask] = SNLP_searchWords(words_ita, corpus.wordlist);
...
for j=1:iterations
    ...
    if(smooth>0)
        wordvectors_extracted = SNLP_getWordVectorsSmoothed(words_ita, corpus.wordlist, corpus.vectors_matrix, words_ita_stem, corpus.wordlist_stem, smooth);
    else
        wordvectors_extracted = SNLP_getWordVectors(words_ita, corpus.wordlist, corpus.vectors_matrix);
    end
